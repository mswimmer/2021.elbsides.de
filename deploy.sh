...
aws $AWS_OPTS resourcegroupstaggingapi tag-resources --tags Project=Elbsides --resource-arn-list arn:aws:s3:::2021.elbsides.de
...
invalidate_files=`grep "upload" /tmp/sync.lst | grep --only-matching "\(s3.*\)" | sed "s/s3:\/\/2021.elbsides.de//"`
